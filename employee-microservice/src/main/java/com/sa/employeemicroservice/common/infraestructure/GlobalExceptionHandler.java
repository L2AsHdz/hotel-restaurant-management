package com.sa.employeemicroservice.common.infraestructure;

import com.sa.employeemicroservice.common.application.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handlerNotFoundException (EntityNotFoudException ex){
        return new ResponseEntity<>(ex.getDetail(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(EmployeeMicroserviceException.class)
    public ResponseEntity<ProblemDetail> handlerServiceException(EmployeeMicroserviceException ex){
